...
export default function ExpertDetails({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-6 md:px-6 lg:py-8">
      ...
      <section className="relative overflow-hidden rounded-[32px] border border-violet-200/60 bg-linear-to-br from-slate-950 via-violet-950 to-fuchsia-900 text-white shadow-[0_30px_80px_-28px_rgba(91,33,182,0.55)]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,255,255,0.18),transparent_0%,transparent_42%)]" />
        <div className="absolute -left-20 top-10 size-56 rounded-full bg-fuchsia-500/15 blur-3xl" />
        ...
        <div className="relative grid gap-6 p-6 lg:grid-cols-[1.2fr_0.8fr] lg:p-8">
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-4">
              <Avatar size="lg" className="size-20 border-4 border-white/20 shadow-xl md:size-24">
                {expert.profilePhoto ? (
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card className="border-fuchsia-200/70 bg-linear-to-br from-fuchsia-50 to-white shadow-sm">
          <CardContent className="flex items-center gap-3 p-5">
            <div className="rounded-full bg-fuchsia-100 p-2 text-fuchsia-700">
        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border bg-violet-50/50 p-4">
                <p className="text-xs uppercase tracking-wide text-violet-700">Best fit for</p>
